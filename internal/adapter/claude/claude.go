...
const resultSchema = `{"type":"object","required":["schema_version","task_id","worker_id","status","summary","work_completed","files_changed","validation","remaining_work","blocking_issues","risks","handoff_notes"],"properties":{"schema_version":{"const":"v1alpha1"},"task_id":{"type":"string"},"worker_id":{"type":"string"},"status":{"enum":["succeeded","partial","blocked","failed","cancelled"]},"summary":{"type":"string"},"work_completed":{"type":"array","items":{"type":"string"}},"files_changed":{"type":"array","items":{"type":"string"}},"validation":{"type":"array","items":{"type":"object","required":["command","passed"],"properties":{"command":{"type":"string"},"passed":{"type":"boolean"},"details":{"type":"string"}}}},"remaining_work":{"type":"array","items":{"type":"string"}},"blocking_issues":{"type":"array","items":{"type":"string"}},"risks":{"type":"array","items":{"type":"string"}},"handoff_notes":{"type":"array","items":{"type":"string"}}}}`
